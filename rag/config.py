...
_CONFIG_PATH = os.environ.get("MEMEX_CONFIG", str(Path(__file__).resolve().parent.parent / "config.yaml"))
...
SPARSE_PROVIDER: str = _cfg_str("sparse.provider", "http")
RERANK_PROVIDER: str = _cfg_str("reranker.provider", "http")
